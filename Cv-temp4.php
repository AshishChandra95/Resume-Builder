...
<head>
    ...
    <link rel="stylesheet" href="Cv-temp4.css">
</head>
<body>
    ...
    <div class="container">
        <div class="main">
            <div class="about">
                <div class="photo"><img src="Picture/<?php echo $row['img_url']; ?>" alt="notshow" class="image">
                <div class="name"><h2><?php echo $row['name']; ?></h2><br>
                <h4><?php echo $row['Job_title']; ?></h4></div>
                </div>
            
                <h3>Career Objective</h3>
                <p>Newly graduated high school student with strong academic record and outstanding communication skills, seeking an entry-level position in [Industry/Field]. Brings enthusiasm, a willingness to learn, and a dedication to contributing positively to the [specific role or team]. Keen interest in developing practical skills in a hands-on environment.</p>
            ...
            <div class="details">
                <h4>Contact</h4>
                    ...
                    <hr id="h-line" style="height: 3px; background-color: #fff;">
